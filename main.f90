...
module dissipativeQFP
    ...
    function dyn(NumSteps, GrdPts, dt, dx) result(f_of_t)
        ...
        do j6=2,GrdPts-1
            ...
            4*D2/16.0/d**4*((f_of_t(t-1,j1+1,j2+1,j3,j4+1,j5+1,j6)-f_of_t(t-1,j1-1,j2+1,j3,j4+1,j5+1,j6)-f_of_t(t-1,j1+1,j2-1,j3,j4+1,j5+1,j6)+f_of_t(t-1,j1-1,j2-1,j3,j4+1,j5+1,j6) - &
            f_of_t(t-1,j1+1,j2+1,j3,j4-1,j5+1,j6)+f_of_t(t-1,j1-1,j2+1,j3,j4-1,j5+1,j6)+f_of_t(t-1,j1+1,j2-1,j3,j4-1,j5+1,j6)-f_of_t(t-1,j1-1,j2-1,j3,j4-1,j5+1,j6) - &
            f_of_t(t-1,j1+1,j2+1,j3,j4+1,j5-1,j6)+f_of_t(t-1,j1-1,j2+1,j3,j4+1,j5-1,j6)+f_of_t(t-1,j1+1,j2-1,j3,j4+1,j5-1,j6)-f_of_t(t-1,j1-1,j2-1,j3,j4+1,j5-1,j6) + &
            f_of_t(t-1,j1+1,j2+1,j3,j4-1,j5-1,j6)-f_of_t(t-1,j1-1,j2+1,j3,j4-1,j5-1,j6)-f_of_t(t-1,j1+1,j2-1,j3,j4-1,j5-1,j6)+f_of_t(t-1,j1-1,j2-1,j3,j4-1,j5-1,j6)) + &
            (f_of_t(t-1,j1+1,j2,j3+1,j4+1,j5,j6+1)-f_of_t(t-1,j1-1,j2,j3+1,j4+1,j5,j6+1)-f_of_t(t-1,j1+1,j2,j3-1,j4+1,j5,j6+1)+f_of_t(t-1,j1-1,j2,j3-1,j4+1,j5,j6+1) - &
            f_of_t(t-1,j1+1,j2,j3+1,j4-1,j5,j6+1)+f_of_t(t-1,j1-1,j2,j3+1,j4-1,j5,j6+1)+f_of_t(t-1,j1+1,j2,j3-1,j4-1,j5,j6+1)-f_of_t(t-1,j1-1,j2,j3-1,j4-1,j5,j6+1) - &
            f_of_t(t-1,j1+1,j2,j3+1,j4+1,j5,j6-1)+f_of_t(t-1,j1-1,j2,j3+1,j4+1,j5,j6-1)+f_of_t(t-1,j1+1,j2,j3-1,j4+1,j5,j6-1)-f_of_t(t-1,j1-1,j2,j3-1,j4+1,j5,j6-1) + &
            f_of_t(t-1,j1+1,j2,j3+1,j4-1,j5,j6-1)-f_of_t(t-1,j1-1,j2,j3+1,j4-1,j5,j6-1)-f_of_t(t-1,j1+1,j2,j3-1,j4-1,j5,j6-1)+f_of_t(t-1,j1-1,j2,j3-1,j4-1,j5,j6-1)) + &
            (f_of_t(t-1,j1,j2+1,j3+1,j4,j5+1,j6+1)-f_of_t(t-1,j1,j2-1,j3+1,j4,j5+1,j6+1)-f_of_t(t-1,j1,j2+1,j3-1,j4,j5+1,j6+1)+f_of_t(t-1,j1,j2-1,j3-1,j4,j5+1,j6+1) - &
            f_of_t(t-1,j1,j2+1,j3+1,j4,j5-1,j6+1)+f_of_t(t-1,j1,j2-1,j3+1,j4,j5-1,j6+1)+f_of_t(t-1,j1,j2+1,j3-1,j4,j5-1,j6+1)-f_of_t(t-1,j1,j2-1,j3-1,j4,j5-1,j6+1) - &
            f_of_t(t-1,j1,j2+1,j3+1,j4,j5+1,j6-1)+f_of_t(t-1,j1,j2-1,j3+1,j4,j5+1,j6-1)+f_of_t(t-1,j1,j2+1,j3-1,j4,j5+1,j6-1)-f_of_t(t-1,j1,j2-1,j3-1,j4,j5+1,j6-1) + &
            f_of_t(t-1,j1,j2+1,j3+1,j4,j5-1,j6-1)-f_of_t(t-1,j1,j2-1,j3+1,j4,j5-1,j6-1)-f_of_t(t-1,j1,j2+1,j3-1,j4,j5-1,j6-1)+f_of_t(t-1,j1,j2-1,j3-1,j4,j5-1,j6-1))))
